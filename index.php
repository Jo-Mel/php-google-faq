...
<body>
    <header>
        <div class="header-top">
            <img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt="google_logo">
    ...
    <main>
        <div class="ctn">
            ...
            <div class="faq-txt">
                <h2><?php echo $data['titolo'] ?></h2>
                <p><?php echo $data['paragrafo'] ?></p>
            </div>
            <?php } ?>  
        </div>
    </main>
